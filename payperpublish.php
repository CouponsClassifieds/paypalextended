        ...
        if($item) {
            ...
            if(!$paid || (isset($paid) && $paid['b_paid'] == 0)) {
                ...
                <div>
                    ...
                    <div style="float:left; width: 50%;">
                        <?php _e("Thanks for adding your listing, you need to pay for premium listings you have selected before they appear. Please use the below button to pay , as soon the payment is recevied we will put your advertisement on the requested featured listings.", 'paypal'); ?>.<br/>
