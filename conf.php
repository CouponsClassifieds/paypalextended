<?php if (!defined('OC_ADMIN') || OC_ADMIN!==true) exit('Access is not allowed.');
    ...
    if(Params::getParam('plugin_action')=='done') {
        ...
        osc_set_preference('pack_price_4', Params::getParam("pack_price_4"), 'paypal', 'STRING');
        osc_set_preference('pack_price_5', Params::getParam("pack_price_5"), 'paypal', 'STRING');
        osc_set_preference('pack_price_6', Params::getParam("pack_price_6"), 'paypal', 'STRING');
        ...
        <div style="float: left; width: 100%;">
            <fieldset>
                ...
                <form name="paypal_form" id="paypal_form" action="<?php echo osc_admin_base_url(true); ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <div style="float: left; width: 50%;">
                        <p>
                            <?php _e("We have 6 'packs' that users can buy, so they don't need to pay each time they publish an ad. The credit from the pack will be stored for later uses.",'paypal'); ?>
                        </p>
                        <br/>
                    </div>
                    <div style="float: left; width: 50%;">

                        <label><?php echo sprintf(__('Urgent 7 days - $12.50', 'paypal'), '1'); ?></label><input type="text" name="pack_price_1" id="pack_price_1" value="<?php echo osc_get_preference('pack_price_1', 'paypal'); ?>" />
                        <br/>
                        <label><?php echo sprintf(__('Link to your website - $5.00', 'paypal'), '2'); ?></label><input type="text" name="pack_price_2" id="pack_price_2" value="<?php echo osc_get_preference('pack_price_2', 'paypal'); ?>" />
                        <br/>
                        <label><?php echo sprintf(__('Urgent Ad $12.50', 'paypal'), '3'); ?></label><input type="text" name="pack_price_3" id="pack_price_3" value="<?php echo osc_get_preference('pack_price_3', 'paypal'); ?>" />
                        <br/>
                         <label><?php echo sprintf(__('Top Ad $7.50', 'paypal'), '4'); ?></label><input type="text" name="pack_price_4" id="pack_price_4" value="<?php echo osc_get_preference('pack_price_4', 'paypal'); ?>" />
                        <br/>
                         <label><?php echo sprintf(__('Homepage Gallery -7 days - $34.25)', 'paypal'), '5'); ?></label><input type="text" name="pack_price_5" id="pack_price_5" value="<?php echo osc_get_preference('pack_price_5', 'paypal'); ?>" />
                        <br/>
                         <label><?php echo sprintf(__('Website URL - 60days - $5.00', 'paypal'), '6'); ?></label><input type="text" name="pack_price_6" id="pack_price_6" value="<?php echo osc_get_preference('pack_price_6', 'paypal'); ?>" />
                        <br/>
