<?php
/*
Plugin Name: Paypal payment extended
Plugin URI: http://www.garagebargain.com/
Description: Paypal payment extended options
Version: 1.0
Author: GarageBargain
Author URI: http://www.garagebargain.com/
Short Name: paypal
Plugin update URI: http://www.garagebargain.com/
*/
    ...
    */
    function paypal_install() {
        ...
        osc_set_preference('pack_price_4', '', 'paypal', 'STRING');
        osc_set_preference('pack_price_5', '', 'paypal', 'STRING');
        osc_set_preference('pack_price_6', '', 'paypal', 'STRING');
    ...
    */
    function paypal_button($amount = '0.00', $description = '', $rpl = '||', $itemnumber = '101') {
        ...
        ?>
            ...
            <div class="buttons">
              <div class="right"><a id="button-confirm" class="button" onclick="$('#payment_<?php echo $r; ?>').submit();"><span><img src='<?php echo paypal_path(); ?>paypal.png' border='0' /></span></a></div>
            </div>
        <?php
        } else {
